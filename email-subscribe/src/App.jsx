				...
				<div className="flex flex-col md:flex-row rounded-l-xl">
					...
					<div className="p-6t md:p-12">
						...
						<div className="flex flex-col mt-5 space-y-4 md:space-x-3 md:flex-row md:space-y-0">
							...
							/>
              <button className="px-5 p-y-3 text-xs rounded-md text-zinc-800 bg-lime-500 hover:bg-lime-700 hover:text-white duration-500">Subscribe</button>
						</div>
					</div>
				</div>
			</div>
